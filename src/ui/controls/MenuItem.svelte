<script lang="ts">
  ...
  let { label, testid, title, disabled = false, hint, onclick }: Props = $props()
</script>
...
<style>
  button {
    ...
    font-family: var(--cond); font-size: 12.5px; letter-spacing: .05em; color: #ddd4c4; text-align: left; white-space: nowrap;
  }
